ARG WINDOWS_VERSION="2004-amd64"
FROM mcr.microsoft.com/windows/servercore:$WINDOWS_VERSION

ARG PYTHON_VERSION=3.8.5
ARG PYTHON_RELEASE=3.8.5
...
LABEL org.opencontainers.image.title="bdwyertech/win-python" \
      org.opencontainers.image.description="Minimal Windows image with Python" \
      org.opencontainers.image.authors="Brian Dwyer <bdwyertech@github.com>" \
      org.opencontainers.image.url="https://hub.docker.com/r/bdwyertech/win-python" \
      org.opencontainers.image.source="https://github.com/bdwyertech/dkr-win-python.git" \
      org.opencontainers.image.revision=$VCS_REF \
      org.opencontainers.image.created=$BUILD_DATE \
      org.label-schema.name="bdwyertech/win-python" \
      org.label-schema.description="Minimal Windows image with Python" \
      org.label-schema.url="https://hub.docker.com/r/bdwyertech/win-python" \
      org.label-schema.vcs-url="https://github.com/bdwyertech/dkr-win-python.git"\
